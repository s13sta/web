...
if ($_GET['Submit'] == 'Send')
{
 ...
 header("Location: mail.php?msg= Mail Sent");
 exit(); 
}
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container">
                    <form action="mail.php" method="GET">
                        ...
                        <textarea class="form-control" aria-label="With textarea" rows="10" cols="10" name="Content" style="width:1000px; height:300px;"></textarea>
